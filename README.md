...
The disaggregation of the WIOD mining sector is conducted in separate preparatory code files (see [R/Data_preparation](/R/Data_preparation)). However, to run the main code, it is not necessary to run the preparatory codes before. 
